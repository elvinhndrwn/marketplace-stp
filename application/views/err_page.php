...
<!-- 					<div class="dashboard-nav-brand">
						<a class="dashboard-logo" href="<?= base_url("properties/admin/") ?>index.html">Concept</a>
					</div> -->
					<!-- ============================================================== -->
					<!-- end brand logo -->
					<!-- ============================================================== -->
					...
					<div class="row">
						<div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
							<div class="error-section">
								<img src="<?= base_url("properties/general/") ?>images/not_found.svg" width="270" alt="" class="img-fluid">
								<div class="error-section-content">
									<h1 class="display-3">Page Not Found</h1>
									<p> Sorry, the page you are going to is unavailable or inaccessible.</p>
									<a href="<?= base_url("admin/login") ?>" class="btn btn-primary btn-lg">Login</a>
								</div>
							</div>
						</div>
					</div>
